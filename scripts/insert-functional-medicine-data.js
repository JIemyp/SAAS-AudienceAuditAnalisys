...
/**
 * Script to insert all 5 v5 module data for Functional Medicine Advocates segment
 * Usage: node scripts/insert-functional-medicine-data.js
 */
...
// Main execution
async function main() {
  console.log('Starting data insertion for Functional Medicine Advocates segment...\n');
  ...
  try {
    ...
    console.log('\n=== ALL 5 MODULES SUCCESSFULLY INSERTED ===');
    console.log('\nSummary:');
